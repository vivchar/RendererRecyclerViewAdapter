...
import com.github.vivchar.example.widgets.ItemsDiffCallback;
...
import com.github.vivchar.example.pages.github.items.RecyclerViewRenderer;
import com.github.vivchar.example.pages.github.items.StargazerModel;
import com.github.vivchar.example.pages.github.items.StargazerViewRenderer;
...
public class GithubFragment extends BaseScreenFragment {
    ...
    private ViewRenderer createUserRenderer() {
        ...
        return new ViewRenderer<StargazerModel, CustomViewFinder>(
                R.layout.item_user_selected, StargazerModel.class,
                (model, finder, payloads) -> finder
